          ...
          <div>
            ...
            <div className="space-y-4">
              <a
                ...
                target="_blank"
                className="flex items-center hover:text-[#02AD25]/80">
              ...
              <a
                ...
                target="_blank"
                className="flex items-center hover:text-black/45 text-white"
              >
                <svg
                  className="h-5 w-5 mr-2"
                  fill="currentColor" width="800px" height="800px" viewBox="0 0 32 32" version="1.1">
                  <title>tiktok</title>
