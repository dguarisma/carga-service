      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <Link href="/" className="flex items-center space-x-2 h-28 w-28 relative">
            <Image src="/logo.webp" alt="CargaService Logo" fill className="aspect-auto object-contain absolute" />
          </Link>
          ...
          <div className="flex items-center gap-4">
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <a
                ...
                className="flex items-center text-[#2078E6] hover:text-[#2078E6]/80"
                rel="noreferrer"
              >
            ...
            <Link href="/cotizar">
              <Button className="bg-[#2078E6] hover:bg-[#2078E6]/90">Cotizar Servicio</Button>
            </Link>
          </div>
        </div>
      </div>
